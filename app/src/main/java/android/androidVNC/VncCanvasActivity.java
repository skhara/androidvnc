...
public class VncCanvasActivity extends Activity {
    ...
    private ArrayAdapter<Display> mDisplayListAdapter;
	...
	public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.canvas_local);
        ...
        if (displays.length <= 1) {
            ...
            showPresentation((Display) displays[1]);
        }
	}
